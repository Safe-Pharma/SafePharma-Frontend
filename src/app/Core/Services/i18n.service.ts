...
const APP_TEXT: Dictionary = {
  en: {
    ...
    'settings.removeLogo': 'Remove', 'settings.street': 'Street', 'settings.city': 'City', 'settings.governorate': 'Governorate',
    'settings.selectCity': 'Select a city', 'settings.searchCities': 'Search cities…', 'settings.selectGovernorate': 'Select a governorate',
  ...
  ar: {
    ...
    'settings.removeLogo': 'إزالة', 'settings.street': 'العنوان', 'settings.city': 'المدينة', 'settings.governorate': 'المحافظة',
    'settings.selectCity': 'اختر المدينة', 'settings.searchCities': 'ابحث عن مدينة…', 'settings.selectGovernorate': 'اختر المحافظة',
